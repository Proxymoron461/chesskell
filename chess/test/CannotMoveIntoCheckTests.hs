...
type WhiteNoLeftRight = (Just (MkPiece White Rook (Info Z (At A Nat1) False)) :-> Nothing :-> Nothing :-> Nothing :-> (Just (MkPiece White King (Info Z (At E Nat1) False))) :-> Nothing :-> Nothing :<> Just (MkPiece White Rook (Info Z (At A Nat1) False)))
                 :-> EmptyRow
                 :-> EmptyRow
                 :-> EmptyRow
                 :-> EmptyRow
...
type BlackNoLeftRight = (Just (MkPiece White Rook (Info Z (At A Nat1) False)) :-> Nothing :-> Nothing :-> Nothing :-> (Just (MkPiece White King (Info Z (At E Nat1) False))) :-> Nothing :-> Nothing :<> Just (MkPiece White Rook (Info Z (At A Nat1) False)))
