...
-- moveTest3 :: Just True :~: Eval ((Flip IsPieceAt) (At "e" 6) <$> (Eval (LastMoveBoardPostMove >>= Move (At "e" 7) (At "e" 6))))
-- moveTest3 = Refl
...
clearPieceTest1 :: Just False :~: Eval (((Flip IsPieceAt) (At "a" 2)) <$> LastMoveBoardPostMove)
