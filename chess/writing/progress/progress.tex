...
type instance Eval (PieceMoveList (MkPiece team Pawn info) boardDec)
    = Eval (If (Eval ((IsZero . GetMoveCount) info)) (PawnStartMove (MkPiece team Pawn info) boardDec) (PawnPostStart (MkPiece team Pawn info) boardDec))
...
type instance Eval (PieceMoveList (MkPiece team Knight info) boardDec)
    = Eval (AllReachableGivenList team boardDec (Eval (GetAllKnightPositions (Eval (GetPosition info)))))
...
Singleton types mimic dependent types in that % TODO:

\subsubsection{EDSL Implementation}

% TODO: Cite dissertation or haskell symposium paper??
