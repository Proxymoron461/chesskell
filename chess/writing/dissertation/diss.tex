...
This section of the dissertation details the general design of Chesskell, including some basics on chess to aid in explanation. Broadly, Chesskell is split into two main sections; the type-level chess model and ruleset, and the value-level EDSL which acts as an interface for the type-level chess model.
