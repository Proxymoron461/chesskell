...
\begin{abstract}
    ...
    \textbf{\textit{Keywords:}} Type-level Programming, GHC, Haskell, EDSL, Chess, First Class Families, Session types.
\end{abstract}